...
void Workshop_Set_Team_f(gentity_t* ent) {
	...
	if (team == TEAM_NEUTRAL)
		g_entities[selectedAI].NPC->behaviorState = BS_HUNT_AND_KILL;
    }
...
void Workshop_Toggle_Follow_f(gentity_t* ent) {
	...
	if (ai->client->leader)
	{
		...
		ai->NPC->defaultBehavior = BS_HUNT_AND_KILL;
...
workshopCmd_t workshopCommands[] = {
	...
	{ "workshop_toggle_follow", "Toggles the NPC following you or not.", WSFLAG_ONLYINWS | WSFLAG_NEEDSELECTED, Workshop_Toggle_Follow_f },
